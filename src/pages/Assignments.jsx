    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        {assignments.map((item) => (
          <div
            key={item.id}
            className="backdrop-blur-lg bg-white/20 border border-white/30 rounded-2xl p-6 shadow-lg 
          ...
          >
            ...
            <Link
              ...
              className="inline-block bg-white text-purple-600 font-medium px-4 py-2 rounded-lg 
